        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <x-Nav-Link href="/HomeAdmin" :active="request()->is('HomeAdmin')">Home</x-Nav-Link>
              <x-Nav-Link href="/kategori" :active="request()->is('kategori')">Kategori</x-Nav-Link>
              <x-Nav-Link href="/penerbit" :active="request()->is('penerbit')">Penerbit</x-Nav-Link>
              <x-Nav-Link href="/pengarang" :active="request()->is('pengarang')">Pengarang</x-Nav-Link>
              <x-Nav-Link href="/buku" :active="request()->is('buku')">Buku</x-Nav-Link>
              <x-Nav-Link href="/pembelian/historyAdmin" :active="request()->is('pembelian/historyAdmin')">Pesanan</x-Nav-Link> 
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
        <!-- Current: "bg-purple-700 text-white", Default: "text-gray-300 hover:bg-purple-500 hover:text-white" -->
              ...
              <x-Nav-Link href="/pengarang" :active="request()->is('pengarang')">Pengarang</x-Nav-Link>
              <x-Nav-Link href="/buku" :active="request()->is('buku')">Buku</x-Nav-Link>
              <x-Nav-Link href="/pembelian/historyAdmin" :active="request()->is('pembelian/historyAdmin')" >Riwayat Pembelian</x-Nav-Link> 
      <div class="border-t border-purple-600 pb-3 pt-6 mt-6">
